...
[hg002v1.2.fasta.gz](https://s3-us-west-2.amazonaws.com/human-pangenomics/T2T/HG002/assemblies/hg002v1.2.fasta.gz) : T2T reconstruction of all 46 chromosomes of HG002 with fixes and improvements. This assembly was created by applying patches contained in the VCF file [hg002v1.1_to_hg002v1.2.vcf.gz](https://github.com/marbl/HG002-issues/blob/main/patches/already_applied/hg002v1.1_to_hg002v1.2.vcf.gz) to 612 problematic regions in the v1.1 assembly. This v1.2 assembly's Merqury-estimated QV using a hybrid database as described in Hansen et al., [A complete diploid human genome benchmark for personalized genomics](https://www.biorxiv.org/content/10.1101/2025.09.21.677443v1). bioRxiv, 2025, is 69.2, compared to an estimate QV of 68.9 for the v1.1 assembly.

In addition to the v1.2 assembly, rDNA "morph" consensus sequences created by ribotin ([Rautiainen, Bioinformatics 2024](https://doi.org/10.1093/bioinformatics/btae124)) have been made available on [AWS](https://s3-us-west-2.amazonaws.com/human-pangenomics/index.html?prefix=T2T/HG002/assemblies/annotation/rdna/hg002_rdnamorphs_v0.1/).

This genome is an update meant for use with [GQC](https://github.com/marbl/GQC). When evaluating HG002 assemblies and read datasets using GQC, use the resource tarball 
...
# Software tools
- [GQC](https://github.com/marbl/GQC) software for benchmarking genome assemblies and read datasets using the HG002v1.2 assembly
...
# History
    ...
    * v1.2: 6th August 2026. V1.2 release.
